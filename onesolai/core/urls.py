...
urlpatterns = [
    ...
    path('wallet/crypto/<str:reference>/', wallet_views.wallet_crypto_topup_view, name='wallet_crypto_topup'),
    path('wallet/crypto/<str:reference>/submit/', wallet_views.wallet_crypto_submit_view, name='wallet_crypto_submit'),
    path('wallet/manual/<str:reference>/', wallet_views.wallet_manual_topup_view, name='wallet_manual_topup'),
    path('wallet/manual/<str:reference>/submit/', wallet_views.submit_wallet_manual_proof_view, name='submit_wallet_manual_proof'),
    ...
    path('automatesocial-bot/', views.automatesocial_docs_view, name='automatesocial_docs'),
